...
//}
var StationList = []Station{} // []*Station{}のほうが存在しないときの nil チェックはしやすいが dbx.Select はこの構造をご所望
...
func initStation() (err error) {
	err := dbx.Select(&StationList, "SELECT * FROM stations ORDER BY id")
	if err != nil {
		return err
	}
